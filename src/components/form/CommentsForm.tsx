          ...
          <div className='mx-auto max-w-screen-md  sm:text-center'>
            <div className='py-2  mb-4 rounded-lg rounded-t-lg '>
              ...
              <textarea
                {...register('message')}                                                                                                                          
                rows={6}
                className={`dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white  border border-gray-600 rounded-lg p-2 w-full text-sm text-amber-100 bg-stone-900  focus:ring-0 placeholder-gray-100 ${styles}`}
